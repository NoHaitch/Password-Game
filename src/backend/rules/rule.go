...
func TestPassword(password string, rule1Var int, rule5Var int, rule8Var []string, rule9Var int, captcha string, rule13Var int, rule15Value []string, rule18Var int) ([]bool, bool, int, int) {
	...
	results := []bool{
		...
		rule15(password, rule15Value),  // Rule 15 – A sacrifice must be made. Pick X letters that you will no longer be able to use
		...
		rule18(rule18Var, numbers),     // Rule 18 – Your password must include the length of your password
		rule19(rule18Var),              // Rule 19 – The length of your password must be a prime number
